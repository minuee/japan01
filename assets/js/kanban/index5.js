...
$( function() {
    ...
    $(document).scroll(function() {
        ...
        if (scrolly > 150) {
            ...
            $('#teamKanban2').removeClass("display_none");
            ...
            $('#teamKanban2').addClass("display_none");
        }
    });
...
$(document).ready(function(){
    ...
    let KanbanSlider2 = $('#teamKanban2').bxSlider({
        autoControls: true,
        speed: 500,
        slideSelector: 'li',
        minSlides: 1,

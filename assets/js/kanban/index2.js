        ...
        success: function (json) {
            if (json.totalCount > 0 ) {
                ...
                for(var i = 0; i < json.dataList.length; i++) {
                    ...
                    if ( xmode == 'todo') {
                        html = "<div class='kanban-item Thisdraggable' style='cursor: move !important;' id='workid_"+json.dataList[i]['ProjectWorkIdx']+"'  data-id='workid_"+json.dataList[i]['ProjectWorkIdx']+"' data-idx='"+json.dataList[i]['ProjectWorkIdx']+"'>";
                    }else{
        ...
        $.ajax({
            ...
            success: function(res){
                if ( res.result === false ) {
                    ...
                    html += "<br >프로젝트 : "+pname+"<span class='project_title_wrap'><i class='fa fa-info-circle noh_cursor btn_click_info' data-idx='"+res.result_idx +"'></i><span class='TargetProjectName'>"+$('#title').val()+"</span></span></div>";
                    $("#ToDoStandbyArea").append(html);

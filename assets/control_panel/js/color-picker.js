...
/***/ (function(module, exports, __webpack_require__) {
	...
	function ColorPicker(options) {
	    ...
	    options = this.options = util.extend({
	        container: null,
	        color: '#181818',
	        preset: ['#181818', '#282828', '#383838', '#585858', '#b8b8b8', '#d8d8d8', '#e8e8e8', '#f8f8f8', '#ab4642', '#dc9656', '#f7ca88', '#ff2f00', '#005bff' , '#a1b56c', '#86c1b9', '#7cafc2', '#ba8baf', '#a16946'],
...
/***/ (function(module, exports) {
	...
	var layout = [
		...
		'<a href="javascript:ui.do_color();" class="color_btn_ok">{{detailTxt2}}</a>',
		'<input type="button" class="{{cssPrefix}}palette-toggle-slider color_btn_view" value="{{detailTxt}}"  />',
		'</div>'].join('\n');

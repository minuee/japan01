            ...
            success: function(res){
                if ( res.result === false ) {
                    ...
                    if ( res.data.TodoID ) {
                        ...
                        makedata.cal_title = $('#title').val();
                        makedata.cal_start = res.data.TmpSdate;
                        makedata.cal_end = res.data.TmpSdate;
                        makedata.cal_id = res.result_idx;
                        makedata.cal_todouser = res.data.TodoUser + "님에게 새업무가 등록되었습니다";//res.data.TodoUser;

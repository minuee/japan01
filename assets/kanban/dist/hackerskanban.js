...
(function() {
  this.HackersKanban = function() {
    ...
    this.addElement = function(boardID, element) {
      ...
      if (typeof element.bgcolor !== "undefined" && element.bgcolor !== "") {
		  console.log('#'+element.bgcolor);
		  if(element.bgcolor.indexOf('-')>-1) { 
			  nodeItem.classList.add(element.bgcolor);  
		  }else {   //TODO : 20200226 색상표 추가
			  nodeItem.style.backgroundColor = '#'+element.bgcolor;
		  }
      }

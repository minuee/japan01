...
class User_model extends CI_Model
{
    ...
    function getUserListing($search, $_select){
        ...
        $this->db->join('ADMIN_MEMBER_GROUP as G', 'A.MEMBER_IDX = G.IDX','left');
    ...
    {
        $this->db->select('BaseTbl.userId, BaseTbl.email, BaseTbl.name,BaseTbl.nickname, BaseTbl.mobile, BaseTbl.roleId, Roles.role');
        $this->db->from('tbl_users as BaseTbl');

              ...
              <!-- general form elements -->
                ...
                <div class="box box-warning">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="<?=$global_face?>" alt="User profile picture">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nickname" name="nickname" placeholder="<?php echo $nickname; ?>" value="<?php echo set_value('nickname', $nickname); ?>" maxlength="128" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">

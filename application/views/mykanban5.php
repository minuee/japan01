...
<div class="content-wrapper" id="page_container">
    ...
    <section class="content">
        ...
        <input type="hidden" id="GlobalReportOk" value="<?=$ReportOk?>">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xs-6 <?=($LoginSession['role'] == ROLE_ADMIN  )?'display_none':'' ?>">
                <!-- small box -->
...
<script src="<?php echo base_url(); ?>assets/kanban/mykanban5.js?v=<?=time()?>"></script>
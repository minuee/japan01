    ...
    <? if ( $isTeamView ) { ?>
        ...
        <div class="Chat_Wrapper">
            <div class="r_con">
                <div class="room_top">
                    <h3>팀채팅</h3>
                    <!--<span class="room_info ToDoStandbyAreaAfter" id="users_count">현재 접속 : 0명</span>-->
        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box2 bg-purple">
                    ...
                    <a class="small-box-footer">
                        ...
                        &nbsp;&nbsp;<span class="btn btn-xs btn-default" onclick="getNotificationPermission();">알림</span>
                    </a>
                </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
            ...
            <div class="col-lg-3 col-xs-6 <?=($LoginSession['role'] == ROLE_EMPLOYEE || $LoginSession['role'] == ROLE_MANAGER )?'':'display_none' ?>">
                <div class="small-box bg-yellow">
                    ...
                    <a  class="small-box-footer">&nbsp;<span class="btn btn-xs btn-warning btn_chat" id="btn_chat">팀채팅 닫기</span></a>
                </div>
            </div><!-- ./col -->
...
<script>
    ...
    $(window).resize(function(){
        ...
        $('.Chat_Wrapper').css({'height':viewHeight});
        ui.display.alam_box();
    });
...
<? if ( $isTeamView ) { ?>
    ...
    <? if ( ENVIRONMENT === "production") { ?>
        <? if ( isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ) { ?>
            <script type="text/javascript" src="https://<?=SSLNODE_SERVER_CIP?>/js/socket.io/1.7.2/socket.io.min.js" id="socket"></script>
        <? }else{ ?>
    ...
    <script>
        ...
        출처: https://dororongju.tistory.com/125?category=716553 [웹 개발 메모장]
        ...
        function notify() {
            ...
            var parameter_noti = {
                ...
                body:"안녕하세요 노성남입니다. 오늘은  Web Notification을 공유하려고 합니다~~~~"
            };
            if (!"Notification" in window) {
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/node/js/ui2.js?v=<?=time()?>"></script>

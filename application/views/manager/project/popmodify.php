                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-left" colspan="3">
                                    <input type="text" class="form-control" id="ProjectTitle" name="ProjectTitle" value="<?=$ProjectData['ProjectTitle']?>" >
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-left group_wrap" colspan="3">
                                    <!--<ul>
                                        <li  class="toggle_chat <?/*=($ProjectData['IsChat']==1?'on':'')*/?>" id="toggle_chat"><?/*=($ProjectData['IsChat']==1?'채팅사용':'채팅사용안함')*/?></li>
                                    </ul>-->
                                    ※ 유지보수는 해당팀에자동배정됩니다.
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        $(document).off('click', '#btn_pop_delete').on('click', '#btn_pop_delete',function() {
            let $this = $(this);

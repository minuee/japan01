...
<div class="content-wrapper" id="page_container" >
    ...
    <section class="content">
        ...
        <div class="h_con TodoWrapper thisdroppable" id="ToDoStandbyArea" ></div>
        ...
        <div class="row">
            <div class="col-lg-12" id="TeamProjectArea" style="text-align:center">
                <ul class="kanban_wrapper hiddenprofilezone display_none"  id="teamKanban2">
                    ...
                    ?>
                    <li class="hidden_kanban-container">
                        <div class="kanban-board profilezone margin_top_0">
                            <span class="profile_image"><img
                                    src="<?= ($trow['FACE_URL'] === NULL ? $FACE_IMAGE_URL."hac.educamp.org/data/user/HAC_" . $trow['USER_ID'] . ".jpg" : $trow['FACE_URL']) ?>"
                                    alt="<?= $trow['USER_NAME'] ?>"></span>
                                        ...
                                        <? }else{ ?>
                                            <main class="kanban-drag2" style="min-height:100px !important;">
                                                <? foreach( $trow['SUB'][2] as $tkey2 => $trow2 )  {
                                                    ...
                                                    ?>
                                                    <div class="kanban-item <?=$trow2['PostColor']?> <?=$trow2['Background']?>" style="cursor: pointer !important; ">
                                                        <?
                                    ...
                                    <div class="kanban-board">
                                        <header class="kanban-board-header info">
                                            <div class="kanban-title-board">
                                                To Do
                                                <span class='f_r <?=(!empty($trow['SITE_IDX']) && $trow['ScheduleIdx'] || $IsRegistPermission !== true || $LoginSession->userdata('role') == ROLE_ADMIN ) ?'display_none':''?>'>
                                        ...
                                        <main class="kanban-drag2 <?=$_isPermission?'thisdroppable':''?>"  id="<?=$trow['SITE_IDX']?>">
                                            ...
                                            <? }else { ?>
                                                <? foreach( $trow['SUB'][1] as $tkey2 => $trow2 )  {
                                                    $trow2['IntraUrl']  ?$_intranetURL = "&nbsp;&nbsp;<a class='intra_page_link' data-url='".$trow2['IntraUrl']."'>☞ 인트라넷 바로가기</a>" : $_intranetURL = "";
                                                    ?>
                                                    <div class="kanban-item <?=$_isPermission?'Thisdraggable':''?> Thissortable<?=$trow['SITE_IDX']?> <?=$trow2['PostColor']?> <?=$trow2['Background']?>" style="cursor: pointer !important;" id="workid_<?=$trow2['ProjectWorkIdx']?>"  data-id="workid_<?=$trow2['ProjectWorkIdx']?>" data-idx="<?=$trow2['ProjectWorkIdx']?>"  data-parent="<?=$trow['SITE_IDX']?>">
                                                        <?
                                                        $trow2['Priority'] == 9  ?$_isemergency = "<span class='emergency'></span>" : $_isemergency = "";
                                                        $trow2['IsReOpen'] == 1  ?$_isIsReOpen = "<span class='reopen'></span>" : $_isIsReOpen = "";
                                                        $trow2['IsReOpen'] == 2  ?$_istogether = "<span class='togetherwork'></span>" : $_istogether = "";
...
<script src="<?php echo base_url(); ?>assets/js/kanban/index5.js?v=<?=time()?>"></script>

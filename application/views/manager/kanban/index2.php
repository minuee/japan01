...
<div class="content-wrapper" id="page_container" >
    ...
    <section class="content">
        <div class="h_con TodoWrapper thisdroppable" id="ToDoStandbyArea" >
            <? if ( count($ToDoReady) > 0 ) { ?>
                <?  foreach( $ToDoReady as $tkey => $trow) {?>
                    <div class="kanban-item Thisdraggable " style="cursor: pointer !important;" id="workid_<?=$trow['ProjectWorkIdx']?>" data-id="workid_<?=$trow['ProjectWorkIdx']?>" data-idx="<?=$trow['ProjectWorkIdx']?>">
                        <? if ( $trow['Priority'] == 9 ) { ?>
        ...
        <div class="h_con TodoWrapper2 display_none" id="CanToDoStandbyArea" >
            <?/* if ( count($ToDoReady) > 0 ) { */?><!--
                <?/*  foreach( $ToDoReady as $tkey => $trow) {*/?>
                    <div class="kanban-item Thissortable " style="cursor: move !important;" id="workid_<?/*=$trow['ProjectWorkIdx']*/?>" data-id="workid_<?/*=$trow['ProjectWorkIdx']*/?>" data-idx="<?/*=$trow['ProjectWorkIdx']*/?>">
                        <?/* if ( $trow['Priority'] == 9 ) { */?>
                            <span class="emergency"></span>
                        <?/* } */?>
                        <?/* if ( $trow['IsReOpen'] == 1 ) { */?>
                                        ...
                                        <main class="kanban-drag2 <?=$_isPermission?'thisdroppable':''?>"  id="<?=$trow['SITE_IDX']?>">
                                            ...
                                            <? }else { ?>
                                                <? foreach( $trow['SUB'][1] as $tkey2 => $trow2 )  {
                                                    $trow2['IntraUrl']  ?$_intranetURL = "&nbsp;&nbsp;<a class='intra_page_link' data-url='".$trow2['IntraUrl']."'>☞ 인트라넷 바로가기</a>" : $_intranetURL = "";
                                                    ?>
                                                    <div class="kanban-item <?=$_isPermission?'Thisdraggable':''?>" style="cursor: pointer !important;" id="workid_<?=$trow2['ProjectWorkIdx']?>"  data-id="workid_<?=$trow2['ProjectWorkIdx']?>" data-idx="<?=$trow2['ProjectWorkIdx']?>"  data-parent="<?=$trow['SITE_IDX']?>">
                                                        <?
                                                        $trow2['Priority'] == 9  ?$_isemergency = "<span class='emergency'></span>" : $_isemergency = "";
                                                        $trow2['IsReOpen'] == 1  ?$_isIsReOpen = "<span class='reopen'></span>" : $_isIsReOpen = "";
                                                        $trow2['IsReOpen'] == 2  ?$_istogether = "<span class='togetherwork'></span>" : $_istogether = "";
...
<script src="<?php echo base_url(); ?>assets/js/kanban/index2.js?v=<?=time()?>"></script>
